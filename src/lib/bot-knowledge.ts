...
function klafText(): string {
  ...
  return `\n\nמידות קלף למזוזות (הקלף אינו כלול!):\n${entries.map(([s, k]) => `• מזוזה ${s} ס״מ → ${k}`).join("\n")}` +
    `\n• חשוב מאוד: המזוזות נמכרות ללא קלף. הקלף אינו כלול בשום מזוזה ואינו מגיע עם ההזמנה. המידות למעלה נועדו רק לעזור ללקוח לדעת איזה גודל קלף לרכוש בנפרד.` +
    `\n• לכל מזוזה יש מכסה תואם לגודל הפתח — המכסה מתאים בדיוק לפתח הקלף של המזוזה.`;
}
...
const FAQ: Record<string, string> = {
  ...
  "משלוח": "משלוח עד 14 ימי עסקים. ספירת ימי העסקים מתחילה מהיום שלמחרת ביצוע ההזמנה — יום ביצוע ההזמנה עצמו לא נספר, וכן לא שישי, שבת וחגים. משלוח חינם בהזמנה מעל ₪200, אחרת עלות משלוח ₪30.",
  "איסוף עצמי": "יש אפשרות לאיסוף עצמי ללא עלות מאחת מנקודות האיסוף: חיפה, רמת ישי, או מגדלי אלון בתל אביב. כשההזמנה מוכנה אנחנו יוצרים קשר לתיאום האיסוף.",
  // "אמצעי תשלום": "",           // אשראי / ביט / פייפאל / תשלומים?
  // "החזרות והחלפות": "",        // מדיניות החזרה/החלפה/אחריות
  // "זמן ייצור": "",             // כמה זמן לוקח לייצר לפני המשלוח?
  "האם הקלף כלול": "לא. המזוזות נמכרות ללא קלף — הקלף אינו כלול בהזמנה. לכל מזוזה מצוין גודל הקלף המתאים לה, כדי שיהיה קל לרכוש קלף מתאים בנפרד.",
  "התקנה": "כל הזמנה מגיעה עם כמות אידיאלית של דבק דו־צדדי איכותי להתקנה. את הדבק אפשר גם לחתוך במספריים להתאמה מדויקת למוצר ולמשטח.",

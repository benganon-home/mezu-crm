...
const FAQ: Record<string, string> = {
  ...
  "משלוח": "משלוח עד 10 ימי עסקים. ספירת ימי העסקים מתחילה מהיום שלמחרת ההזמנה. משלוח חינם בהזמנה מעל ₪200, אחרת עלות משלוח ₪30.",
  "איסוף עצמי": "יש אפשרות לאיסוף עצמי — ניצור קשר לתיאום.",

...
const FAQ: Record<string, string> = {
  ...
  "משלוח": "משלוח עד 10 ימי עסקים. ספירת ימי העסקים מתחילה מהיום שלמחרת ביצוע ההזמנה — יום ביצוע ההזמנה עצמו לא נספר, וכן לא שישי, שבת וחגים. משלוח חינם בהזמנה מעל ₪200, אחרת עלות משלוח ₪30.",
